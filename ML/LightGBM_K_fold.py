...
# Input data
# ------------------------------------------------------------------------------
train_files = sorted(glob.glob('../input/indoorpositioningdata/train_data/*'))
test_files = sorted(glob.glob('../input/indoorpositioningdata/test_data/*'))
...
if __name__ == '__main__':
    ...
    for n_files, file in enumerate(train_files):
        ...
        for fold, (trn_idx, val_idx) in enumerate(kf.split(data.iloc[:, :-3])):
            ...
            if new_x or not(os.path.exists(f'{n_files}modelx.txt')):
                new_x = True
            ...
            if new_y or not(os.path.exists(f'{n_files}modely.txt')):
                new_y = True
            ...
            if new_f or not(os.path.exists(f'{n_files}modelf.txt')):
                new_f = True
